...
class GemTest {
    ...
    class LogicGemTest {
        ...
        void testAddAllGemTypes() {
            for (int gemType = 0; gemType <= 4; gemType++) {
                ...
                when(inputReader
                        ...
                        .thenReturn(gemType);
                when(inputReader.readNonNegativeInt("Choose gem precious type (1 - Precious, 2 - SemiPrecious):"))
                        .thenReturn(1);
                when(inputReader.readNonNegativeDouble("Enter gem weight (carats):")).thenReturn(1.5);
                when(inputReader.readNonNegativeDouble("Enter price per carat:")).thenReturn(100.0);
                when(inputReader.readDoubleBetweenXAndY("Enter transparency (0.0 - 1.0):", 0.0, 1.0)).thenReturn(0.8);
                ...
                switch (gemType) {
                    case 1: // Opal
                        when(inputReader
                                ...
                                .thenReturn(3);
                        when(inputReader.readDoubleBetweenXAndY("Enter fire intensity (0.0 - 1.0):", 0.0, 1.0))
                                .thenReturn(0.9);
                        break;
                    case 2: // Amethyst
                        when(inputReader.readDoubleBetweenXAndY("Enter clarity (0.0 - 1.0):", 0.0, 1.0))
                                .thenReturn(0.7);
                        when(inputReader.readDoubleBetweenXAndY("Enter color intensity (0.0 - 1.0):", 0.0, 1.0))
                                .thenReturn(0.6);
                        break;
                    case 3: // Topaz
                        when(inputReader.readIntBetweenXAndY("Enter hardness (1 - 10):", 1, 10)).thenReturn(5);
                        when(inputReader.readDoubleBetweenXAndY("Enter light reflectivity (0.0 - 1.0):", 0.0, 1.0))
                                .thenReturn(0.8);
                        break;
                    case 4: // Sapphire
                        when(inputReader.readIntBetweenXAndY("Enter hardness (1 - 10):", 1, 10)).thenReturn(5);
                        when(inputReader.readDoubleBetweenXAndY("Enter brilliance (0.0 - 1.0):", 0.0, 1.0))
                                .thenReturn(0.9);
                        break;
                }
        ...
        void testUpdateGemAllFields() {
            ...
            when(inputReader.readNonNegativeInt("Enter ID of gem to update:")).thenReturn(1);
            when(inputReader.readString("Enter new name (" + gem.getName() + "):")).thenReturn("Ruby");
            when(inputReader
                    .readIntBetweenXAndY(
                            "Choose gem precious type (1 - Precious, 2 - SemiPrecious) (" + gem.getType() + "):", 1, 2))
                    .thenReturn(2);
            when(inputReader.readNonNegativeDouble("Enter new weight in carats (" + gem.getWeightCarat() + "):"))
                    .thenReturn(3.5);
            when(inputReader.readNonNegativeDouble("Enter new price per carat (" + gem.getPricePerCarat() + "):"))
                    .thenReturn(200.0);
            when(inputReader.readDoubleBetweenXAndY(
                    "Enter new transparency (0.0 - 1.0) (" + gem.getTransparency() + "):", 0.0, 1.0))
                    .thenReturn(0.8);
        ...
        void testUpdateGemNotFound() {
            ...
            when(inputReader.readNonNegativeInt("Enter ID of gem to update:")).thenReturn(999);
        ...
        void testDeleteGemConfirmed() {
            ...
            when(inputReader.readNonNegativeInt("Enter ID of gem to delete:")).thenReturn(1);
            when(gemService.getGemById(1)).thenReturn(gem);
        ...
        void testDeleteGemCanceled() {
            ...
            when(inputReader.readNonNegativeInt("Enter ID of gem to delete:")).thenReturn(2);
        ...
        void testDeleteGemNotFound() {
            when(inputReader.readNonNegativeInt("Enter ID of gem to delete:")).thenReturn(3);
        ...
        void testSortGemsByWeight() {
            ...
            when(inputReader.readNonNegativeInt("Select option:")).thenReturn(1);
        ...
        void testSortGemsByPricePerCarat() {
            ...
            when(inputReader.readNonNegativeInt("Select option:")).thenReturn(2);
        ...
        void testFilterGemsByTransparency() {
            ...
            when(inputReader.readMinAndMaxTransparency()).thenReturn(new double[] { 0.3, 0.5 });
        ...
        void testFilterGemsByTransparencyNoResults() {
            when(inputReader.readMinAndMaxTransparency()).thenReturn(new double[] { 0.9, 1.0 });
        ...
        @Test
        void testShowGemHierarchy() {
            Gem preciousGem = new Gem("Diamond", GemType.Precious, 2.0, 200.0, 0.9, "Clear");
            Gem semiPreciousGem = new Gem("Amethyst", GemType.SemiPrecious, 1.5, 100.0, 0.8, "Purple");

            when(gemService.getAllGems()).thenReturn(List.of(preciousGem, semiPreciousGem));
            ...
            assertTrue(output.contains("Precious Gems:"));
            assertTrue(output.contains("Diamond"));
            assertTrue(output.contains("Semi-Precious Gems:"));
            assertTrue(output.contains("Amethyst"));
        ...
        class TopazTest {
            ...
            void testTopazConstructorAndGetters() {
                ...
                assertEquals(7, topaz.getHardness());
            ...
            void testTopazSetters() {
                ...
                assertEquals(6, topaz.getHardness());
            }
        }
        ...
        class SapphireTest {
            ...
            void testSapphireConstructorAndGetters() {
                ...
                assertEquals(9, sapphire.getHardness());
